    ...
    return (
        <div className="flex-1">
            ...
            <div className="relative border-l-2 border-border-light/50 ml-4 md:ml-6 space-y-12">
                {selectedRoutes.length === 0 && unattachedHotels.length === 0 ? (
                    <div className="ml-8 text-text-muted font-bold tracking-wide italic">No items added to your trip yet.</div>
                ) : (
                    <>
                        ...
                        {unattachedHotels.length > 0 && (
                            <div className="relative pl-8 md:pl-10 pb-4">
                                <div className="absolute -left-[11px] top-6 w-5 h-5 rounded-full bg-accent-teal border-[4px] border-primary-bg z-10 shadow-[0_0_15px_rgba(13,148,136,0.6)] animate-pulse"></div>
                                <h3 className="font-extrabold text-xl text-white tracking-wide mb-6">Independent Hotel Stays</h3>
                                <div className="space-y-4">
                                    {unattachedHotels.map(hotel => (
                                        <div key={hotel.id} className="glass-card p-4 border-l-4 border-l-accent-teal flex justify-between items-center group hover:bg-white/[0.02] hover:border-accent-teal/50 transition-all">
                                            <div className="flex items-center gap-4">
                                                <div className="w-12 h-12 rounded-xl bg-accent-teal/10 text-accent-teal flex items-center justify-center shrink-0 border border-accent-teal/20 shadow-inner">
                                                    <Building2 className="w-6 h-6" />
